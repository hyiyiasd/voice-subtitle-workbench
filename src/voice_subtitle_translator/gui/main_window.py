...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.task_tree.setHeaderLabels(["æ–‡ä»¶å¤¹ / åª’ä½“", "è¿›åº¦"])
        self.task_tree.setColumnWidth(0, 240)
