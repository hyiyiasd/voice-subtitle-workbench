...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.task_tree.setHeaderLabels(["æ–‡ä»¶å¤¹ / åª’ä½“", "çŠ¶æ€"])
    ...
    def _build_actions(self) -> None:
        ...
        gpu_action = QAction("GPU æ¨ç†è®¾ç½®", self)
